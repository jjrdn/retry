function retry (fn, options) {
  ...
  if (typeof timeout === 'number') {
    if (timeout < 0) {
      throw new Error('timeout timeout cannot be a negative number');
    }

    (function(){
      var backoffTimeout = timeout;
      timeout = function() { return backoffTimeout; };
    })();
  }
  ...
  function operation () {
    ...
    function retryCallback(error) {
      ...
      var thisTimeout = timeout(attempts);
